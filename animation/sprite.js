...
,	requestAnimationFrame = animator.requestAnimationFrame
,	cancelAnimationFrame = animator.cancelAnimationFrame;
 /* Class CanvasSprite
 ...
 *		anim(ate):		  // add the sprite to animation loop 
 *		stopAnimate():   // remove the sprite from animation loop 
 *		addCollisioin(): // add sprite to collision dectetion list
 *		deleteCollision(): // delete sprite from collision dectetion list
...
var CanvasSprite = function(params){
	...
	that = {
		...
		type: params.type || '',
		collide: params.collide || function(){},
		vector : params.vector || vector(0, 0),
		accelerator : params.accelerator || vector(0, 0), 
